...
--
-- Name: walletdestroyer_earningmodel; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public.walletdestroyer_earningmodel (
    id bigint NOT NULL,
    user_id integer NOT NULL,
    cost integer NOT NULL,
    time_create date NOT NULL,
    CONSTRAINT walletdestroyer_earningmodel_cost_check CHECK ((cost >= 0)),
    CONSTRAINT walletdestroyer_earningmodel_user_id_check CHECK ((user_id >= 0))
);


ALTER TABLE public.walletdestroyer_earningmodel OWNER TO "user";

--
-- Name: walletdestroyer_earningmodel_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.walletdestroyer_earningmodel ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.walletdestroyer_earningmodel_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: walletdestroyer_spendingcategoriesmodel; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public.walletdestroyer_spendingcategoriesmodel (
    id bigint NOT NULL,
    name character varying(30) NOT NULL
);


ALTER TABLE public.walletdestroyer_spendingcategoriesmodel OWNER TO "user";

--
-- Name: walletdestroyer_spendingcategoriesmodel_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.walletdestroyer_spendingcategoriesmodel ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.walletdestroyer_spendingcategoriesmodel_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: walletdestroyer_spendingmodel; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE public.walletdestroyer_spendingmodel (
    id bigint NOT NULL,
    user_id integer NOT NULL,
    cost integer NOT NULL,
    ...
    category_id bigint,
    CONSTRAINT walletdestroyer_spendingmodel_cost_check CHECK ((cost >= 0)),
    CONSTRAINT walletdestroyer_spendingmodel_user_id_check CHECK ((user_id >= 0))
);


ALTER TABLE public.walletdestroyer_spendingmodel OWNER TO "user";

--
-- Name: walletdestroyer_spendingmodel_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE public.walletdestroyer_spendingmodel ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.walletdestroyer_spendingmodel_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
25	Can add Earning	7	add_earningmodel
26	Can change Earning	7	change_earningmodel
27	Can delete Earning	7	delete_earningmodel
28	Can view Earning	7	view_earningmodel
29	Can add Spending	8	add_spendingmodel
30	Can change Spending	8	change_spendingmodel
31	Can delete Spending	8	delete_spendingmodel
32	Can view Spending	8	view_spendingmodel
33	Can add spending categories model	9	add_spendingcategoriesmodel
34	Can change spending categories model	9	change_spendingcategoriesmodel
35	Can delete spending categories model	9	delete_spendingcategoriesmodel
36	Can view spending categories model	9	view_spendingcategoriesmodel
\.
...
6	sessions	session
7	walletdestroyer	earningmodel
8	walletdestroyer	spendingmodel
9	walletdestroyer	spendingcategoriesmodel
\.
...
1	contenttypes	0001_initial	2023-10-10 12:37:13.803039+00
2	auth	0001_initial	2023-10-10 12:37:13.87018+00
3	admin	0001_initial	2023-10-10 12:37:13.88884+00
4	admin	0002_logentry_remove_auto_add	2023-10-10 12:37:13.894837+00
5	admin	0003_logentry_add_action_flag_choices	2023-10-10 12:37:13.90107+00
6	contenttypes	0002_remove_content_type_name	2023-10-10 12:37:13.910657+00
7	auth	0002_alter_permission_name_max_length	2023-10-10 12:37:13.91654+00
8	auth	0003_alter_user_email_max_length	2023-10-10 12:37:13.923764+00
9	auth	0004_alter_user_username_opts	2023-10-10 12:37:13.928943+00
10	auth	0005_alter_user_last_login_null	2023-10-10 12:37:13.934222+00
11	auth	0006_require_contenttypes_0002	2023-10-10 12:37:13.936439+00
12	auth	0007_alter_validators_add_error_messages	2023-10-10 12:37:13.941733+00
13	auth	0008_alter_user_username_max_length	2023-10-10 12:37:13.952395+00
14	auth	0009_alter_user_last_name_max_length	2023-10-10 12:37:13.958386+00
15	auth	0010_alter_group_name_max_length	2023-10-10 12:37:13.966721+00
16	auth	0011_update_proxy_permissions	2023-10-10 12:37:13.972105+00
17	auth	0012_alter_user_first_name_max_length	2023-10-10 12:37:13.977784+00
18	sessions	0001_initial	2023-10-10 12:37:13.991686+00
19	walletdestroyer	0001_initial	2023-10-10 12:38:08.370706+00
\.
...
--
-- Data for Name: walletdestroyer_earningmodel; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.walletdestroyer_earningmodel (id, user_id, cost, time_create) FROM stdin;
\.


--
-- Data for Name: walletdestroyer_spendingcategoriesmodel; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.walletdestroyer_spendingcategoriesmodel (id, name) FROM stdin;
\.


--
-- Data for Name: walletdestroyer_spendingmodel; Type: TABLE DATA; Schema: public; Owner: user
--

COPY public.walletdestroyer_spendingmodel (id, user_id, cost, description, time_create, time_update, category_id) FROM stdin;
\.
...
--
-- Name: walletdestroyer_earningmodel_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.walletdestroyer_earningmodel_id_seq', 1, false);


--
-- Name: walletdestroyer_spendingcategoriesmodel_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.walletdestroyer_spendingcategoriesmodel_id_seq', 1, false);


--
-- Name: walletdestroyer_spendingmodel_id_seq; Type: SEQUENCE SET; Schema: public; Owner: user
--

SELECT pg_catalog.setval('public.walletdestroyer_spendingmodel_id_seq', 1, false);
...
--
-- Name: walletdestroyer_earningmodel walletdestroyer_earningmodel_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.walletdestroyer_earningmodel
    ADD CONSTRAINT walletdestroyer_earningmodel_pkey PRIMARY KEY (id);


--
-- Name: walletdestroyer_spendingcategoriesmodel walletdestroyer_spendingcategoriesmodel_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.walletdestroyer_spendingcategoriesmodel
    ADD CONSTRAINT walletdestroyer_spendingcategoriesmodel_pkey PRIMARY KEY (id);


--
-- Name: walletdestroyer_spendingmodel walletdestroyer_spendingmodel_pkey; Type: CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.walletdestroyer_spendingmodel
    ADD CONSTRAINT walletdestroyer_spendingmodel_pkey PRIMARY KEY (id);
...
--
-- Name: walletdestroyer_spendingmodel_category_id_e4fe2eee; Type: INDEX; Schema: public; Owner: user
--

CREATE INDEX walletdestroyer_spendingmodel_category_id_e4fe2eee ON public.walletdestroyer_spendingmodel USING btree (category_id);
...
--
-- Name: walletdestroyer_spendingmodel walletdestroyer_spen_category_id_e4fe2eee_fk_walletdes; Type: FK CONSTRAINT; Schema: public; Owner: user
--

ALTER TABLE ONLY public.walletdestroyer_spendingmodel
    ADD CONSTRAINT walletdestroyer_spen_category_id_e4fe2eee_fk_walletdes FOREIGN KEY (category_id) REFERENCES public.walletdestroyer_spendingcategoriesmodel(id) DEFERRABLE INITIALLY DEFERRED;
